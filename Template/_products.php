                    ...
                    <div class="col-6">
                        ...
                        <div class="color my-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="p-2 bg-yellow-color rounded-circle"><button class="btn font-size-14"></button></div>
                                <div class="p-2 bg-primary-color rounded-circle"><button class="btn font-size-14"></button></div>
                                <div class="p-2 bg-second-color  rounded-circle"><button class="btn font-size-14"></button></div>
                            </div>
                        </div>
                        <!-- !color -->
                    </div>
